					...
					<div>
						...
						<form onSubmit={onsubmit}>
							<div className={r.groupform}>
								...
								<input onKeyUp={changeInput} autoComplete="off" required={true} id="name" name="name" type="text" placeholder="Input your name"/>
							</div>
							<div className={r.groupform}>
							...
							<div className={r.groupform}>
								...
								<input onKeyUp={changeInput} autoComplete="off" required={true} id="verify-password" name="verifyPassword" type="password" placeholder="Input your password"/>
							</div>
