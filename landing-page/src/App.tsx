...
function App() {
  ...
  const [visi, setvisi] = useState<_visi>([])
  const [applist, setapplist] = useState<_applist>([])
  ...
  useEffect(() => {
    ...
    let ontext: string = "perangkat lunak, Iot dan blockchain.", int, slice: number = 1
    int = setInterval(() => {
